...
def apply_transformation_Z(Z, A):
    """
    ...
    Inputs:
    - Z: A numpy array of shape (2, 2*n) containing unit circle points.
    - A: A numpy array of shape (2, 2) containing the transformation matrix.

    Returns:
    - X: A numpy array of shape (2, 2*n) containing the transformed set of 
